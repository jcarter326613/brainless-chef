...
Brainless Chef is a TypeScript monorepo containing a React web application, an Express API, a local Qwen prompt experiment, and Terraform for Google Cloud deployment.
